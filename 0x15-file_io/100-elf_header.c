...
/**
 * print_class - Prints out the ELF header class.
...
/**
 * print_abi - Prints out ABI version of the ELF header.
...
/**
 * main - Displays the information contained at the start of ELF file header
 * @argc: The arguments number to be supplied to the program.
